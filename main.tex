...
% \chapter*{Agraïments}
% A l'hora de tancar aquesta etapa, vull agrair a totes les persones que l'han feta possible. A l'equip d'Embedded de \textit{Lanaccess} --- \textit{Xavi Rovira}, \textit{Sergio Sanz}, \textit{Carles Silva} i \textit{Jorge Gil} --- i especialment a \textit{Fernan Gallego}, per la confiança i l'oportunitat. Al meu ponent, \textit{Carles Farré}, pel seu guiatge i rigor. Als meus \textit{pares} i a la \textit{Clàudia}, per tot.
% \newpage
