...
% \chapter*{Agraïments}
% A l'hora de tancar aquesta etapa, vull agrair a totes les persones que l'han feta possible. A l'equip d'Embedded de \textsc{Lanaccess} --- \textsc{Xavi Rovira}, \textsc{Sergio Sanz}, \textsc{Carles Silva} i \textsc{Jorge Gil} --- i especialment a \textsc{Fernan Gallego}, per la confiança i l'oportunitat. Al meu ponent, \textsc{Carles Farré}, pel seu guiatge i rigor. Als meus \textsc{pares} i a la \textsc{Clàudia}, per tot.
% \newpage
