...
\begin{itemize}
    ...
    \item \textbf{API REST (HTTP):} S'utilitza per a operacions \textit{stateless} i síncrones, principalment a través del mòdul \textit{Core Legacy}. Aquest canal gestiona la consulta i l'enviament de paràmetres de configuració.
...
L'elecció d'Angular 19 no és casual; el marc de treball proporciona una estructura opinada que facilita el manteniment a llarg termini d'una aplicació de gran envergadura.
