...
\begin{itemize}
  ...
  \item \textbf{Justificació:} S'ha optat per la solució \textbf{Schema-driven} per garantir la compatibilitat futura amb els nous models de videogravador NXT de Lanaccess sense haver de modificar el codi de l'aplicació web.
\end{itemize}
