...
% ---  DIAPOSITIVA — Pàgina de Configuració  ---
\begin{frame}{Configuració de Sistema}
  \begin{columns}[T]
    \begin{column}{0.45\textwidth}
      ...
      \vspace{0.4em}
      \begin{itemize}
        \item \texttt{ipaddr}, \texttt{list}, \texttt{integer}\ldots \textbf{10 tipus}.
        \item 100\% de la config coberta.
      \end{itemize}

      \vspace{0.4em}
      \begin{alertblock}{Config Lock Pessimista}
        \small \textbf{POST /lock} $\to$ token $\cdot$ expira \textbf{60--120 s}.\\
